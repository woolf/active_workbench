...
If you not specify -c option, then results output will shown in console.


== Sample

Sample output of Sakila example database which you can download here http://dev.mysql.com/doc/index-other.html
